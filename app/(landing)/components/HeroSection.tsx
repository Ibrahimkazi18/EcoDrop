    ...
    return (
        <div className="mt-4 h-[95vh] py-20 flex gap-8">
            <div className="left ml-16 w-[50%] h-full p-4">
                ...
                <button className="outline-none rounded-full bg-green-400 px-6 py-2 text-black font-black text-lg transition delay-100 ease-in-out hover:-translate-y-1 hover:scale-110">Recycle Now</button>
            </div>

...
import { Loader, User, Trophy, Crown, Award } from "lucide-react"
...
const LeaderBoardPage = ({ params }: { params: { citizenId: string } }) => {
    ...
    const fetchCitizenVolunteerAgency = async () => {
        try {
            ...
            if (!agenciesRes.ok) throw new Error(agenciesData.error || "Failed to fetch citizens");
            if (!volunteersRes.ok) throw new Error(volunteersData.error || "Failed to fetch citizens");
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2 items-center justify-between">
                    ...
                    <Select onValueChange={(value) => setRole(value as Role)} required defaultValue="citizen">
                        <SelectTrigger className="w-full bg-indigo-50 dark:bg-black">

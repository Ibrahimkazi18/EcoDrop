...
export default function VolunteerNavbar() {
  ...
  return (
    <nav
      className={`flex items-center bg-black justify-between p-3 sm:p-4 dark:shadow-slate-900 shadow-md sticky top-0 z-50 w-[100vw] ${isOpen ? `xl:w-[83vw] lg:w-[74.5vw]` : `xl:w-[97.1vw] lg:w-[95.5vw]`
        }`}
    >
